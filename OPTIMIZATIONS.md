...
**Verdict:** No consistent improvement (within run-to-run variance). Flag kept as an optional operational knob for deployments that do not need the visualizer, but not counted as a performance win.
